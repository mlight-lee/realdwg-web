...
describe('AcGeSpline3d', () => {
  ...
  describe('Closed Spline', () => {
    ...
    it('should not create straight line between second-to-last and last point in closed spline', () => {
      // Test with the specific fit points from the user's example
      const fitPoints = [
        { x: 138.2158028887, y: 123.17237798546, z: 0 },
        { x: 166.63079392051, y: 142.99679033324, z: 0 },
        { x: 184.47276503351, y: 127.79807419994, z: 0 },
      ...
      expect(startPoint.y).toBeCloseTo(lastPoint.y, 6)
      expect(startPoint.z).toBeCloseTo(lastPoint.z, 6)
    })
  })
})
